        ...
        >
          ...
          >
            ...
            <article className="group relative overflow-hidden bg-transparent">
              ...
              <a
                className="absolute inset-0 grid place-items-center bg-[rgb(0_0_0_/_0.32)] text-[0.85rem] font-bold text-white opacity-0 no-underline transition-opacity duration-300 after:content-['_→'] group-hover:opacity-100"
                href="https://sippos.github.io/Sprite-Workbench/"
                target="_blank"
                rel="noopener noreferrer"
              >
                View Live App
            ...
            <article className="group relative overflow-hidden bg-transparent">
              <img
                className="block aspect-video w-full bg-[rgb(17_17_17_/_0.06)] object-cover transition duration-500 ease-out group-hover:scale-[1.025] group-hover:brightness-[0.88]"
                src="/Resume/assets/software/Musip.png"
                alt="Cover image for Musip"
                loading="lazy"
              />
              <div className="pt-3">
                <div className="mb-2 flex flex-wrap gap-1.5">
              ...
              <a
                className="absolute inset-0 grid place-items-center bg-[rgb(0_0_0_/_0.32)] text-[0.85rem] font-bold text-white opacity-0 no-underline transition-opacity duration-300 after:content-['_→'] group-hover:opacity-100"
                href="https://sippos.github.io/Musip/"
                target="_blank"
                rel="noopener noreferrer"
              >
                View Project
            ...
            <article className="group relative overflow-hidden bg-transparent">
              <img
                className="block aspect-video w-full bg-[rgb(17_17_17_/_0.06)] object-cover transition duration-500 ease-out group-hover:scale-[1.025] group-hover:brightness-[0.88]"
                src="/Resume/assets/software/pokemonautobattler.png"
                alt="Cover image for Poke Roguelite/Autobattler"
                loading="lazy"
              />
              <div className="pt-3">
                <div className="mb-2 flex flex-wrap gap-1.5">
              ...
              <a
                className="absolute inset-0 grid place-items-center bg-[rgb(0_0_0_/_0.32)] text-[0.85rem] font-bold text-white opacity-0 no-underline transition-opacity duration-300 after:content-['_→'] group-hover:opacity-100"
                href="https://pokemon-battlegame-frontend.vercel.app"
                target="_blank"
                rel="noopener noreferrer"
              >
                View Live App
            ...
            <article className="group relative overflow-hidden bg-transparent">
              <img
                className="block aspect-video w-full bg-[rgb(17_17_17_/_0.06)] object-cover transition duration-500 ease-out group-hover:scale-[1.025] group-hover:brightness-[0.88]"
                src="/Resume/assets/software/nihomi.png"
                alt="Cover image for Nihomi"
                loading="lazy"
              />
              <div className="pt-3">
                <div className="mb-2 flex flex-wrap gap-1.5">
              ...
              <a
                className="absolute inset-0 grid place-items-center bg-[rgb(0_0_0_/_0.32)] text-[0.85rem] font-bold text-white opacity-0 no-underline transition-opacity duration-300 after:content-['_→'] group-hover:opacity-100"
                href="https://nihomi-frontend.vercel.app/"
                target="_blank"
                rel="noopener noreferrer"
              >
                View Live App
